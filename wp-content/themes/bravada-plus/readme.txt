...
Bravada Plus WordPress Theme bundles the following third-party libraries and resources:
...
* Fixed menu in over-image mode overlapping content when header image is hidden via meta option
* Fixed the Contact 2 page template missing the specific meta options
* Clarified availablility message about specific page template meta options
* Synchronized with Bravada 1.0.5:
...
* Synchronized with Bravada 1.0.4:
...
* Synchronized with Bravada 1.0.3.1:
...
* Synchronized with Bravada 1.0.3:
	...
	* Fixed back to top button animation when using child themes (1.0.2.3)
	* Improved preloader handling (1.0.2.2)
	* Fixed issue when disabling the header title animation (1.0.2.1)

= 1.0.2 =
*Release date: 2020.12.31*

* Synchronized with Bravada 1.0.2:
...
* Synchronized with Bravada 1.0.1:
...
* First Bravada Plus release, based on Bravada 1.0.0
